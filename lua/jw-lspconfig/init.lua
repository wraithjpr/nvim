...
local servers = { 'bashls', 'cssls', 'dockerls', 'efm', 'html', 'jsonls', 'pyright', 'sqlls', 'sumneko_lua', 'tsserver', 'yamlls' }
...
-- TODO make more sophisticated ala https://github.com/kabouzeid/nvim-lspinstall/wiki
